...
def run_full_pipeline():
    ...
    reference_img = os.path.join(asset_dir, "step1_cat_base_final.jpg")
    base_img = os.path.join(output_dir, "step1(2)_base.png")
    mask_img = os.path.join(output_dir, "step2(2)_mask.png")
    svg_output = os.path.join(output_dir, "step3(2)_final.svg")
...
#     reference_img = os.path.join(asset_dir, "step1_cat_base_final.png")
#     base_img = os.path.join(output_dir, "step1_cat_base_final.png")
#     mask_img = os.path.join(output_dir, "step2_cat_mask.png")
